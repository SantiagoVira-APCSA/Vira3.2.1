public class CatHouseRunner {
    public static void main(String[] args) {
        ...
        Cat fernando = new Cat("Fernando", 12);
        Cat bob = new Cat("Bob", 10);

        CatHouse house = new CatHouse(fernando, bob, "Santiago");
        ...
        System.out.println("Fernando's age: " + fernando.getAge());
        System.out.println("Bob's age: " + bob.getAge());
        System.out.println("Fernando says: " + fernando.speak());
        System.out.println("Bob says: " + bob.speak());
